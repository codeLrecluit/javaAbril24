...
public class Principal {
	...
	public static void main(String[] args) {
		...
		List<Alumno> alumnos = new ArrayList<Alumno>();//CREACION DE UNA LISTA DE TIPO ALUMNO DE TIPO DE DATO STRING, PURO TEXTO
		//LAS LISTAS SON VERSATILES Y SE PUEDE ALMACENAR TIPO DE OBJETOS DESADOS
		
		//SE CREA UNA LISTA DE TIPO ALUMNO
		String nombre;
		int edad;
		...
		Scanner sc = new Scanner(System.in); //PERMITE EXPLORAR METODOS DE LISTA
		int seleccion = 0;
		Alumno al = null;
